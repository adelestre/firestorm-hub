        ...
        <ListElement>
          ...
          <List className="list-disc">
            ...
            <ListElement>
              ...
              />{' '}
              - Good versa/haste procs if you have an healer and tank to proc
              it. It's imo weaker than the two previous options if you manage to
              get full gear and good stats (and gems).
            </ListElement>
          </List>
        </ListElement>
        <ListElement>
