  ...
  return sectionContext && navigationContext && headerRef.current ? (
    <div className="pointer-events-none absolute inset-0">
      <button
        ...
        className={`anim pointer-events-auto absolute z-30 h-screen w-screen bg-black opacity-50 sm:z-auto lg:hidden ${navigationContext.navigation ? '' : '!pointer-events-none !opacity-0'}`}
      />
      <div className="z-30">
        <div
