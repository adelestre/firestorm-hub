  ...
  return (
    <Section name="Utility">
      ...
      <Paragraph>
        ...
        <ItemLink item={spells['mage-spell_steal']} />. You should try to learn
        every dungeons buffs/curses/shields/heals that you can steal or remove
        as some are pretty insane. There is very powerfull buffs that can almost
        double your DPS, provide you insane amount of shields, damage reduction,
        etc.
      </Paragraph>
      <Paragraph>
        We also an interesting defensive for our group with{' '}
        <ItemLink item={spells['mage-mass_barrier']} />, that can be switched to{' '}
